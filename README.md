...
[![codecov](https://codecov.io/gh/mbnoimi/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/mbnoimi/fastapi-template)
[![CI](https://github.com/mbnoimi/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/mbnoimi/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by mbnoimi

## Install

from source
```bash
git clone https://github.com/mbnoimi/fastapi-template fastapi_template
cd fastapi_template
make install
```
